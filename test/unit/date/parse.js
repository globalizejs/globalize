define([
	...
	enCaGregorian, enNumbers, zhCaGregorian, zhNumbers, likelySubtags, timeData, weekData,
...
QUnit.test( "should parse date according to passed timeZone in various datetime patterns",
	...
	// BRT
	// Note we can"t reliably parse "2017-02-19T00:00:00.000Z" without providing the zone string,
	// e.g., 11:00 PM BRT.
	assert.dateParseWithTimezone(
		"2/18/2017 10:00 PM",
		"M/d/y h:mm a",
		"America/Sao_Paulo",
		cldr,
		new Date( "2017-02-19T00:00:00.000Z" )
	);
	...
	assert.dateParseWithTimezone(
		...
		"America/Sao_Paulo",
		cldr,
		new Date( "2017-02-19T02:00:00.000Z" )
	);
...
QUnit.test( "should parse date according to passed timeZone in various date patterns",
			function( assert ) {
	assert.dateParseWithTimezone(
		"1/1/2017",
		"M/d/y",
