...
// Globalize instance can be created without new keyword
var Globalize = function( culture ) {
	return new Globalize.prototype.init( culture );
};

// Expose Globalize as a global variable, unless an 'exports'
