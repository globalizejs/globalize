...
(function() {
	...
	*/
	...
	customNumberFormat = function( value, format, formatInfo ) {
		...
		function normalize( patterns, value ) {
			...
			switch ( patterns.length ) {
				...
				case 2:
					...
					/* falls through */
				case 1:
					curPattern = patterns[0];
			}

			return [ zeroPattern, curPattern, value ];
		}
		
		// patterns = format.split(/(?<!(?:[\\]{2})*\\);/, 3)
		var normalizedInput = normalize( notEscapedSplit( format, ";", 3 ), value ),
			zeroPattern = normalizedInput.shift(),
			pattern = normalizedInput.shift();

		value = normalizedInput.shift();
